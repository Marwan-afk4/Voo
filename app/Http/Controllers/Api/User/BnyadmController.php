...
class BnyadmController extends Controller
{
    ...
    public function BeBnyadm(Request $request){
        ...
        $Validation = Validator::make($request->all(), [
            ...
            'orgnization_papers'=>'required|string',
        ]);
        if ($Validation->fails()) {
        ...
        $create = UserPaper::create([
            ...
            'selfi_image' =>$this->storeBase64Image($request->selfi_image, 'user/user_papers'),
            'orgnization_papers' =>$this->storeBase64Image($request->orgnization_papers, 'user/user_papers'),
        ]);
